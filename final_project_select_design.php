...
//function getNewID()
//{
//    $query="SELECT MAX(select_id) FROM final_project_select";
//    $result=  mysql_query($query) or die(mysql_error());
//    while ($row=  mysql_fetch_array($result))
//    {
//        $select_id=$row['MAX(select_id)'];
//        if($select_id==0)
//        {
//            $select_id=1;
//        }
 ...
 ?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Final project selection</h2>
          </div>
        
          <div class="service bg-white" style="width: 800px;margin-left: 150px;">
     

<form action="final_project_select_code.php">
    <?php
            ...
            if(isset($_GET['select_id']))
            {
                ...
                $mid=$_GET['mentor_id'];
                $meid=$_GET['mentee_id'];
                $accept_reject=$_GET['accept_reject'];
    ...
    <div class="form-group row">
              ...
              <!--<div class="col-lg-3"></div>-->
                <div class="col-lg-6">
                    <div class="text-black">Accept-Reject : </div>
                    <input type="text" class="form-control" name="txt_accept_reject" value="<?php echo($accept_reject);?>" >
                </div>
    </div>
    <div class="form-group row">
           <?php
...
$query="SELECT * from final_project_select";
...
echo 
    ...
    for ($i=0;$i<$num;$i++)
    {
        ...
        echo "<tr>";
        echo "<td><a href='final_project_select_design.php?select_id=".$row['select_id'] ."&topic_id=" .$row['topic_id'] ."&mentor_id=" .$row['mentor_id'] ."&mentee_id=" .$row['mentee_id'] ."&accept_reject=" .$row['accept_reject'] ."'>Select</a></td>";
        echo "<td>" .$row[0] ."</td>";
        echo "<td>" .$row[1] ."</td>";
         echo "<td>" .$row[2] ."</td>";
          echo "<td>" .$row[3] ."</td>";
