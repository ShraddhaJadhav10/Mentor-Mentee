...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Menteewise project topic dynamic report</h2>
          </div>
      ...
      <div class="form-group row">
       ...
       <input type="submit" value="Show" name="btn" class="btn btn-block btn-primary"  style="width: 100px">
            ...
            {     
                ...
                $query="SELECT topic_id,mentor_nm,type_nm,topic_nm,topic_date,topic_details from project_sem_topic,mentee,mentor where project_sem_topic.mentee_id=mentee.mentee_id and project_sem_topic.mentor_id=mentor.mentor_id and project_sem_topic.mentee_id='" .$mentee_id ."'";
                //echo $query;
