 ...
 <div class="site-section bg-light"  id="services-section" >
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Final Project Selection List Report</h2>
          </div>
...
$query="select select_id,topic_nm,mentor_nm,mentee_nm,accept_reject from final_project_select,project_sem_topic,mentor,mentee where final_project_select.topic_id=project_sem_topic.topic_id and final_project_select.mentor_id=mentor.mentor_id and final_project_select.mentee_id=mentee.mentee_id ";
