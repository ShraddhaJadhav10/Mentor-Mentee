    ...
    <body>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Branchwise Mentor Report</h2>
          </div>
...
<?php
    if(isset($_GET["btn"]))
    {
        ...
        $query= "select mentor_nm, branch_nm, mentor_phone from mentor, branch where branch.branch_id=mentor.branch_id and branch.branch_id='".$branch_id."'";
        //echo $query;
        $result=mysql_query($query) or die("Query failed.".mysql_error()); 
         $num=(int)@mysql_num_rows($result);
        // echo "<h1> Branchwise Mentor Report </h1>";
         echo "<table align=center class='table' border=5 cellspacing=5>";
       echo "<tr>
                <td><b> Mentor Name </b></td>
                <td><b> Mentor Branch </b></td>
