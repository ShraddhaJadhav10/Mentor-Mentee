...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Menteewise final project selection dynamic report</h2>
          </div>
      ...
      <div class="form-group row">
       ...
       <input type="submit" value="Show" name="btn" class="btn btn-block btn-primary"  style="width: 100px">
            ...
            {     
                ...
                $query="SELECT select_id,topic_nm,mentor_nm,mentee_nm,accept_reject from final_project_select,project_sem_topic,mentor,mentee where final_project_select.topic_id=project_sem_topic.topic_id and final_project_select.mentor_id=mentor.mentor_id and final_project_select.mentee_id=mentee.mentee_id and final_project_select.mentee_id='" .$mentee_id ."'";
                //echo $query;
