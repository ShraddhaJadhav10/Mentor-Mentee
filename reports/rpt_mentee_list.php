 ...
 <div class="site-section bg-light"  id="services-section" >
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Mentee List Report</h2>
          </div>
...
$query="SELECT mentee_id,roll_no,mentee_nm,mentee_class,branch_nm,mentee_year,mentee_email,mentee_pass from mentee,branch where mentee.branch_id=branch.branch_id";
$result=  mysql_query($query) or die("Query failed." .mysql_error());
//echo "Query executed successfully." ."<br/>";
$num=(int)@mysql_numrows($result);
//echo"<h1>Mentee List Report</h1>";
...
echo 
    "<tr>
        ...
        <td><b>Mentee_Class</b></td>
        <td><b>Branch_Name</b></td>
        <td><b>Mentee_Year</b></td>
        <td><b>Mentee_Email</b></td>
        <td><b>Mentee_Password</b></td>
    </tr>";
    for ($i=0;$i<$num;$i++)
    {
