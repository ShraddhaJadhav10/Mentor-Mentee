 ...
 <div class="site-section bg-light"  id="services-section" >
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Project Semester Topic Details List Report</h2>
          </div>
...
$query="SELECT topic_id,mentee_nm,mentor_nm,type_nm,topic_nm,topic_date,topic_details from project_sem_topic,mentee,mentor where project_sem_topic.mentee_id=mentee.mentee_id and project_sem_topic.mentor_id=mentor.mentor_id";
//echo '$query';
$result=  mysql_query($query) or die("Query failed." .mysql_error());
//echo "Query executed successfully." ."<br/>";
$num=(int)@mysql_numrows($result);
//echo"<h1>Project Sem Topic List Report</h1>";
