...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Project semester topic datewise report</h2>
          </div>
 ...
 <form>
   ...
   <?php
         ...
         {     
                ...
                $query="SELECT topic_id,mentee_nm,mentor_nm,type_nm,topic_nm,topic_date,topic_details from project_sem_topic,mentee,mentor where project_sem_topic.mentee_id=mentee.mentee_id and project_sem_topic.mentor_id=mentor.mentor_id and topic_date  between '".$From_date."' and '".$To_date."'" ;
