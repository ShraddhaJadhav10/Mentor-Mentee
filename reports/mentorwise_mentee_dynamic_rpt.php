    ...
    <body>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="../Mentor_dashboard.php" class="nav-link">Dashbord</a></li>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Dynamic Mentorwise Mentee Report</h2>
          </div>
        
          <div class="service bg-white" style="width: 800px;margin-left: 150px;">
        <form>
            Select Mentor: <select name="txt_mentor_id">
                        <?php
                            $mentor_id=0;
                            $mentor_name="";
                            ...
                            for($i=0;$i<$num;$i++)
                            {
                             ...
                             $mentor_name=$row['mentor_nm'];
                        ?>
                                <option value="<?php echo($mentor_id);?>">
...
<?php
    if(isset($_GET["btn"]))
    {
        ...
        $query= "select mentor_nm, roll_no, mentee_nm, mentee_class, branch_nm ,mentee_year, mentee_email from mentor, guide_assign, mentee, branch where mentor.mentor_id=guide_assign.mentor_id and guide_assign.mentee_id=mentee.mentee_id and branch.branch_id=mentee.branch_id and branch.branch_id=mentor.branch_id and mentor.mentor_id='".$mentor_id."'";
        $result=mysql_query($query) or die("Query failed.".mysql_error()); 
         $num=(int)@mysql_num_rows($result);
//         echo "<h1> Dynamic Report for Mentorwise Mentee </h1>";
         echo "<table align=center class='table' border=5 cellspacing=5>";
       echo "<tr>
                <td><b> Mentor Name </b></td>
                <td><b> Mentee Roll Number </b></td>
                <td><b> Mentee Name </b></td>
                <td><b> Mentee Class </b></td>
                <td><b> Mentee Branch Name </b></td>
