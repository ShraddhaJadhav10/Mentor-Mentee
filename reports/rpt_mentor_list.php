 ...
 <div class="site-section bg-light"  id="services-section" >
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Mentor List Report</h2>
          </div>
...
$query="SELECT mentor_id,branch_nm,mentor_nm,mentor_email,mentor_phone,mentor_password from mentor,branch where mentor.branch_id=branch.branch_id";
$result=  mysql_query($query) or die("Query failed." .mysql_error());
//echo "Query executed successfully." ."<br/>";
$num=(int)@mysql_numrows($result);
//echo"<h1>Mentor List Report</h1>";
