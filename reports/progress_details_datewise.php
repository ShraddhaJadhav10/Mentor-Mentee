...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Progress details datewise report</h2>
          </div>
 ...
 <form>
     <div class="form-group row">
              ...
              <!--<div class="col-lg-3"></div>-->
                <div class="col-lg-6">
                    <div class="text-black">From Date : </div> 
                  <input type="text" class="form-control" name="txt_from_date">
                </div>
     </div>
     <div class="form-group row">
              <!--for center-->
              <!--<div class="col-lg-3"></div>-->
                <div class="col-lg-6">
                    <div class="text-black">To Date : </div> 
                     <input type="text" class="form-control" name="txt_todate">
                </div>
     </div>
          <div class="form-group row">
          <div class="col-lg-4"> 
   ...
   <?php
         if(isset($_GET["btn"])) 
         {     
                $From_date=$_GET["txt_from_date"];
                $To_date=$_GET["txt_todate"];
                $query= "SELECT progress_id,topic_nm,mentor_nm,mentee_nm,progress_date,description,project_copy from progress_details,mentee,mentor,final_project_select,project_sem_topic where progress_details.select_id=final_project_select.select_id and final_project_select.topic_id=project_sem_topic.topic_id and progress_details.mentee_id=mentee.mentee_id and progress_details.mentor_id=mentor.mentor_id and progress_date  between '".$From_date."' and '".$To_date."'"  ;
                 ...
                 for ($i=0;$i<$num;$i++)
                 {
                       $row=  mysql_fetch_array($result);
                          echo "<tr>";
                            ...
                            echo"<td><a href='../coaching-master/demo.php?nm=" .$row[6]."'>".$row[6]."</td>";
                          echo "</tr>";
                    }
                echo "</table>";
