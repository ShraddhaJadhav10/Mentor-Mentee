 ...
 <div class="site-section bg-light"  id="services-section" >
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Guide Assign List Report</h2>
          </div>
...
$query="SELECT guide_id,mentor_nm,mentee_nm from mentor,mentee,guide_assign where guide_assign.mentor_id=mentor.mentor_id and guide_assign.mentee_id=mentee.mentee_id";
$result=  mysql_query($query) or die("Query failed." .mysql_error());
//echo "Query executed successfully." ."<br/>";
$num=(int)@mysql_numrows($result);
//echo"<h1>Guide_Assign List Report</h1>";
