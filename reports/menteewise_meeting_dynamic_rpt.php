...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Menteewise meeting dynamic report</h2>
          </div>
      ...
      <div class="form-group row">
       ...
       <input type="submit" value="Show" name="btn" class="btn btn-block btn-primary"  style="width: 100px">
            ...
            {     
                ...
                $query="select meet_id,meet_date,mentor_nm,meet_details,present_absent from meeting,mentor,mentee where meeting.mentor_id=mentor.mentor_id and meeting.mentee_id=mentee.mentee_id and meeting.mentee_id='" .$mentee_id ."'";
                //echo $query;
