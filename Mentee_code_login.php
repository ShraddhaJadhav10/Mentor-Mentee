<?php
        ...
        $query="SELECT * from mentee where mentee_email='".$menteemail."' and mentee_pass='".$menteepass."'";
...
//        
    if($num>0)
    {
        ...
        echo "<script> location.href='mentee_dashboard.php' </script>";
    }
    else 
    {
       echo "<script>alert('Email or Password incorrect ')</script>";
       echo "<script>location.href='mentee_login.php'</script>";
    }
