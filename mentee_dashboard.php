...
?>
      ...
      <div class="container">
          ...
          <div class=" text-center">
            <h2 class="text-black">Mentee Dashboard</h2>
          </div>
          ...
          <div class="service bg-white" style="width: 800px;margin-left: 150px;">
            ...
            <tr>
                <td><h3>Manage</h3></td>
                <td><a href="project_sem_topic_design.php">Project Semester Topic Details</a></td>
            </tr>
             <tr>
                <td></td>
                <td><a href="progress_details_design.php">Progress Details</a></td>
            </tr>
            ...
            <tr>
                <td></td>
                <td><a href="reports/menteewise_final_project_select.php">final project selection dynamic report</a></td>
            </tr>
            
             <tr>
                <td></td>
                <td><a href="reports/menteewise_meeting_dynamic_rpt.php">Menteewise meeting dynamic report</a></td>
            </tr>
        </table>
               </div>
          </div>
